...
constexpr std::size_t
cholesky_trsm(const tiled_scheduler_sma &sched, std::size_t /*n_tiles*/, std::size_t k, std::size_t m)
{
...
constexpr std::size_t
solve_gemv(const tiled_scheduler_sma &sched, std::size_t /*n_tiles*/, std::size_t k, std::size_t m)
{
    return (k + m) % sched.num_localities;
}
...
constexpr std::size_t solve_matrix_gemm(
...
constexpr std::size_t
multiply_gemv(const tiled_scheduler_sma &sched, std::size_t /*n_tiles*/, std::size_t k, std::size_t m)
{
    return (k + m) % sched.num_localities;
}
